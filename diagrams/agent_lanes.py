# diagrams/agent_lanes.py
"""
Wrapper per diagrammi agent-driven (lanes):
...
def generate_all_agent_lanes_diagrams(json_file: str, output_dir: str):
    ...
    for i, proc in enumerate(procedures):
        ...
        base = os.path.join(out_dir, f"{i:03d}_{base_name}_wf")
